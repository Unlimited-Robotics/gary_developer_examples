...
class ArmMoveitClient():
    ...
    def start(self):
        ...
        request_position = ([np.deg2rad(0.0),np.deg2rad(0),np.deg2rad(0.0),np.deg2rad(90.0),np.deg2rad(0.0),np.deg2rad(0.0),np.deg2rad(-0.0)])
        ...
        request_position = ([np.deg2rad(0.0),np.deg2rad(0),np.deg2rad(0.0),np.deg2rad(0.0),np.deg2rad(0.0),np.deg2rad(0.0),np.deg2rad(-0.0)])
        self.right_py_moveit.move_to_configuration(request_position,self.right_joint_names)
